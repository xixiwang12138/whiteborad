...
import shanchu from "../../icon/删除.svg";
import bianzu from "../../icon/编组.svg";
import fontB from "../../icon/加粗.svg";
import fontI from "../../icon/斜体.svg";
import fontU from "../../icon/下划线.svg";
import fontl from "../../icon/左对齐.svg";
import fontr from "../../icon/右对齐.svg";
import fontc from "../../icon/居中对齐.svg";
